...
# Desc : The class stores 2 values: name & data. name is used for the tokenname. data is used for the actual data. 
...
# Desc : The class stores 2 values: type & connections. type is used for the current node type. connection is used for storing underlying nodes. This class is accessible with [] operator.
